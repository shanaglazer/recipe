...
begin
	...
	SELECT u.UsersID, u.UserName, c.Active, c.cookbookid, c.DateCreated, c.BookName, Author = concat(u.firstname, ' ', u.lastname), x.NumOfRecipes, c.Price, c.Skill, c.SkillDesc
	FROM Cookbook c
	join users u
